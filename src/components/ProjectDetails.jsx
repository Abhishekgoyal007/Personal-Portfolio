...
const ProjectDetails = ({ title, description, tags, subDescription, href, image, closeModal }) => {
  return (
        ...
        <motion.div 
            ...
            <div className='p-5'>
                ...
                <div className='flex items-center justify-between mt-4'>
                    ...
                    <a className='inline-flex items-center gap-1 cursor-pointer font-medium hover-animation'>
                        View Project
